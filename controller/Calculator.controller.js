sap.ui.define([
	...
	return Controller.extend("tatapower.dev.controller.Calculator", {
		...
		var key = val.getSelectedKey();
		 ...
		 oEntry.Cmd.toString();
			...
			var that = this;		 
		 	...
		 	this.oDataModel.create("/CalculateBillSet",oEntry,null,
				{
					async : true,
					success:function(oData)
					{
	   ...
	   onAddToList: function(){
        ...
        var oData = [{EquipName:EqupName, DailyCon:DailyCon, MonthlyConCon:MonthlyCon}];
        ...
        oModel.setData({oTableModel: oData});                     // Set the data to the model using the JSON            
        oTable.setModel(oModel);  
        oTable.bindItems({path:"/oTableModel",template:oTemplate});
        // this.doSum();
	   },
	   ...
	   onRemoveFromList: function(){
        ...
        var oModel = new sap.ui.model.json.JSONModel();             // created a JSON model      
        oModel.setData({oTableModel: aData});                     // Set the data to the model using the JSON            
        oTable.setModel(oModel);  
        oTable.bindItems({path:"/oTableModel",template:oTemplate});
